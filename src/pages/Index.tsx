    ...
    <div className="font-nunito bg-[#fdf9f5] text-gray-800 overflow-x-hidden">
      ...
      <section className="pt-20 min-h-screen flex items-center relative overflow-hidden bg-gradient-to-br from-yellow-50 via-orange-50 to-pink-50">
        ...
        <div className="max-w-6xl mx-auto px-4 py-12 relative z-10">
          ...
          {/* ГЛАВНЫЙ БЛОК: слева название+текст, справа цветок */}
            ...
            <div className="flex items-center justify-center">
              <div className="relative w-[420px] h-[420px]">
                ...
                <div className="absolute rounded-full overflow-hidden border-[5px] border-white shadow-2xl"
                  style={{ width: 220, height: 220, top: 0, left: '50%', transform: 'translateX(-50%)' }}>
                ...
                {/* нижний левый */}
                <div className="absolute rounded-full overflow-hidden border-[5px] border-white shadow-2xl"
                  style={{ width: 220, height: 220, bottom: 0, left: 0 }}>
                ...
                {/* нижний правый */}
                <div className="absolute rounded-full overflow-hidden border-[5px] border-white shadow-2xl"
                  style={{ width: 220, height: 220, bottom: 0, right: 0 }}>
