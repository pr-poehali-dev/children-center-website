      ...
      <div className="max-w-6xl mx-auto px-4 py-12 relative z-10 w-full">
        ...
        <div className="flex flex-col md:flex-row items-center gap-8 mb-8">
          ...
          <div className="flex-1 text-center md:text-left">
            ...
            <h1 className="font-pacifico text-5xl sm:text-6xl md:text-7xl lg:text-8xl text-[#2a6e8c] leading-none mb-3">
              Рыбка Долли
            </h1>
            <p className="font-pacifico text-xl sm:text-2xl md:text-3xl text-[#f7a825]">Дети наше всё!</p>
          </div>
        ...
        <div className="max-w-3xl">
          ...
          <div className="flex flex-col sm:flex-row flex-wrap gap-3 mb-8">
            <a href="https://vk.com/app6379730_-179759189#l=6" target="_blank"
              className="px-6 py-3 bg-[#4f86f7] text-white font-bold text-base rounded-2xl hover:bg-[#3570e0] transition-all shadow-lg hover:shadow-xl hover:-translate-y-1 text-center">
              🏠 Подробнее о садике →
            </a>
            <button onClick={() => scrollTo("запись")}
              className="px-6 py-3 bg-[#e85d3b] text-white font-bold text-base rounded-2xl hover:bg-[#c94d2e] transition-all shadow-lg hover:shadow-xl hover:-translate-y-1">
              Записаться на экскурсию
            </button>
            <a href="https://vk.com/app6379730_-179759189#l=8" target="_blank" rel="noopener noreferrer"
              className="px-6 py-3 bg-[#f7c948] text-gray-800 font-bold text-base rounded-2xl hover:bg-[#e6b830] transition-all shadow-lg hover:shadow-xl hover:-translate-y-1 text-center">
