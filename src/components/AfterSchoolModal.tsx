        ...
        <div className="px-6 pb-8 pt-5">
          ...
          <div className="space-y-4 mb-6">
            {[
              ...
              {
                icon: "🍽️",
                title: "Вкусный обед и полдник. Как дома",
                desc: "Домашняя еда, а не чипсы из автомата. Кормим вкусно и с заботой.",
              },
              {
                icon: "🎯",
                title: "Развитие без скуки",
                desc: "Английский — играючи, творчество, прогулки на свежем воздухе, общение со сверстниками. Работаем и на каникулах.",
              },
              {
                icon: "🔒",
