...
const prices = [
  { service: "Ясельная группа — полный день", price: "от 20 000 ₽/мес" },
  { service: "Ясельная группа — неполный день", price: "от 18 000 ₽/мес" },
  { service: "Старшая группа — полный день", price: "от 20 000 ₽/мес" },
  { service: "Старшая группа — неполный день", price: "от 18 000 ₽/мес" },
  { service: "Логопед (индивидуально)", price: "от 800 ₽/занятие" },
  { service: "Группа продлённого дня", price: "от 12 500 ₽/мес" },
  { service: "Английский язык", price: "от 4 500 ₽/мес" },
  { service: "Летний клуб", price: "от 12 500 ₽/мес" },
];
